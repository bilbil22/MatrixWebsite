 ...
 */
 (function() {
    ...
    function Q() {
        ...
        K = G && G.replace("request", "exit").replace("mozRequest", "mozCancel").replace("Request", "Exit");
        r(window, "resize",
            function() {
                L = x.clientWidth;
                M = x.clientHeight;
    ...
    function V() {
        C = !1;
        if (document.fullscreen || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement) return document[K](), !0
    }
    e.close = function() {
        this.min && U(this);
        this.j && this.j();
    ...
    e.move = function(a, b, c) {
        "undefined" === typeof a ? (a = this.x, b = this.y) : c || (this.x = a ? a = R(a, L - this.left - this.right, this.width) : 0, this.y = b ? b = R(b, M - this.top - this.bottom, this.height) : 0);
        w(this.g, "transform", "translate(" + a + "px," + b + "px)");
        this.o && this.o(a, b);
        return this
    };
    e.resize = function(a, b, c) {
        "undefined" === typeof a ? (a = this.width, b = this.height) : c || (this.width = a ? a = R(a, L - this.left - this.right) : 0, this.height = b ? b = R(b, M - this.top - this.bottom) : 0);
        w(this.g, "width", a + "px");
